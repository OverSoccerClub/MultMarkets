...
async function main() {
    ...
    const sampleMarkets = [
        ...
        },
        {
            ...
            resolutionCriteria: 'Resolverá SIM se o par BTC/USDT na Binance atingir ou superar 110.000,00 em qualquer momento de 2025.',
        ...
        },
        {
            ...
            resolutionCriteria: 'Resolverá SIM se a SpaceX confirmar um pouso bem-sucedido (ou soft landing) de uma Starship em Marte até 31/12/2026.',
        ...
        },
        {
            ...
            resolutionCriteria: 'Resolverá SIM se a Rockstar Games lançar o GTA VI para qualquer plataforma antes de 01/10/2025.',
        ...
        {
            slug: 'neymar-santos-2025',
            title: 'Neymar Jr. vai assinar contrato com o Santos FC em 2025?',
            description: 'Este mercado foca no retorno do craque Neymar ao clube que o revelou.',
            resolutionCriteria: 'Resolverá SIM se houver anúncio oficial do Santos FC sobre a contratação de Neymar Jr. em 2025.',
            categoryId: esportes?.id,
            yesPrice: 0.58,
            noPrice: 0.42,
            yesShares: 420,
